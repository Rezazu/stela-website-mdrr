...
--
-- Host: localhost
-- Generation Time: Oct 07, 2022 at 08:38 AM
...
INSERT INTO `tiket` (`id`, `no_tiket`, `id_via`, `tipe_pelapor`, `id_pelapor`, `nama_pelapor`, `bagian_pelapor`, `gedung_pelapor`, `unit_kerja_pelapor`, `ruangan_pelapor`, `lantai_pelapor`, `telepon_pelapor`, `hp_pelapor`, `email_pelapor`, `keterangan`, `permasalahan_awal`, `permasalahan_akhir`, `solusi`, `id_sub_kategori`, `tanggal_pelaksanaan`, `id_status_tiket`, `rating_pekerjaan`, `rating_kecepatan`, `rating_total`, `tanggal_tiket`, `status`, `user_input`, `tanggal_input`, `user_update`, `tanggal_update`) VALUES
